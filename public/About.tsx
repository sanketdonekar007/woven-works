      ...
      <header className="header about-header">
        ...
        <nav className="navigation">
          <ul>
            ...
            <li><a href="hhttps://drive.google.com/file/d/1p0QgBKIbkBFpyf8r9aY4qmHxXZScjgtb/view?usp=drive_link" target="_blank" rel="noopener noreferrer">Resume</a></li>
          </ul>
        </nav>
      </header>
        ...
        <div className="about-text">
          ...
          <div className="experience-section">
            ...
            <div className="experience-item">
              <h3>UX Designer, RedBeryl Tech Solutions.</h3>
