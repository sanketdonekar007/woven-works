    ...
    <div className="portfolio-container ">
      ...
      >
        <div className="hero-content min-[1400px]:px-72">
          ...
          <h1 className="intro">
            I'm <span className="name">Sanket</span>, a creative UX/UI designer focused on crafting functional and visually stunning experiences.
          </h1>
          <p className="position">
            UX/UI Designer @ RedBeryl Tech | Previously @ Esofcode & KnackBe Tech
          </p>
        </div>
  ...
  <span className="lock-icon">🔒</span> Read More
      ...
      >
        <div className="footer-content min-[1400px]:px-72">
          ...
          <h2 className="footer-title">View my <a href="https://drive.google.com/file/d/1p0QgBKIbkBFpyf8r9aY4qmHxXZScjgtb/view?usp=drive_link" target="_blank" rel="Sanket Donekar" className="resume-link">resume</a>, get in touch 👋</h2>
