...
const experience = [
  {
    ...
    bullets: [
      "Enterprise supply chain SaaS — cut shipment creation from 45 min to 8 min in usability testing (n=6) across 5 stakeholder teams.",
      "Multi-tenant compliance SaaS — 45% faster filing cycles and 70% fewer client status inquiries in internal pilot sessions.",
      "US HealthTech scanner — cut scan-to-decision time by 33% in usability testing.",
      "US EdTech tutor marketplace — redesigned tutor onboarding and verification, targeting a 30–40% cut in drop-off (shipped; impact not yet measured).",
      "3 atomic design systems — faster feature rollout and less developer rework reported across product teams.",
