      ...
      <div className="about-content">
        <div className="about-text">
          ...
          <div className="about-bio">
            ...
            <p className="contact-email">sanket.donekar@gmail.com | +91 8149760321</p>
          </div>
        ...
        <div className="about-photo">
          <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=600&h=800" alt="Sanket Donekar" />
        </div>
      </div>
    </div>
  );
